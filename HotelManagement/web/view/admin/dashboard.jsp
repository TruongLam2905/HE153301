<%-- 
    Document   : dashboard
    Created on : Oct 31, 2021, 11:34:01 AM
    Author     : Admin
--%>
                                ...
                                <ul class="notification-list">
                                        ...
                                        <a href="#">
                                            <div class="media"> <span class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" alt="User Image"
                                                         src="${contextPath}/css/assets/img/profiles/avatar-02.jpg">
                                                </span>
                                    ...
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media"> <span class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" alt="User Image"
                                                         src="${contextPath}/css/assets/img/profiles/avatar-17.jpg">
                                                </span>
                                                <div class="media-body">
                                    ...
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media"> <span class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" alt="User Image"
                                                         src="${contextPath}/css/assets/img/profiles/avatar-13.jpg">
                                                </span>
                                                <div class="media-body">
