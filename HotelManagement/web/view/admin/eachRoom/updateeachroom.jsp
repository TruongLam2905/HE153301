        ...
        <div class="main-wrapper">
                    ...
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Room </span> <span class="menu-arrow"></span></a>
                                <ul class="submenu_class" style="display: none;">
                                    <li><a href="listEachroom">All Room </a></li>
                                    <li><a href="edit-staff.html"> Edit Room </a></li>
                                    <li><a class="active" href="add-staff.html"> Add Room </a></li>
                                </ul>
                            </li>
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="updateeachroom" method="POST">
                                <div class="row formtype">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Room ID</label>
                                            <input class="form-control" name="roomid" type="text" value="${requestScope.room.roomID}"> 
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Description</label>
                                            <input class="form-control" name="desc" type="text" value="${requestScope.room.description}"> 
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group header-item">
                                            ...
                                            <select name="typeID" class="form-control">
                                                <c:forEach items="${requestScope.typeRooms}" var="tr">
                                                    <option
                                                        ...
                                                        value="${tr.roomTypeID}">${tr.typeName}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
