<%-- 
    Document   : room
    Created on : Oct 24, 2021, 2:38:46 AM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="index.html">Phu Quoc</a>
                    ...
                    <c:forEach items="${requestScope.typeRooms}" var="r">
                        <div class="col-lg-6">
                            <div class="room-wrap d-md-flex">
                                <a href="roomdetail" class="img" style="background-image: url(data:image/jpg;base64,${r.base64Image});"></a>
                                <div class="half left-arrow d-flex align-items-center">
                                    <div class="text p-4 p-xl-5 text-center">
                                        ...
                                        <h3 class="mb-3"><a href="roomdetail">${r.typeName}</a></h3>
                                        <p class="pt-1"><a href="roomdetail?roomID=${r.roomTypeID}" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
