                                ...
                                <div class="card-body booking_card">
                                    <div class="table-responsive">
                                        <table class="datatable table table-stripped table table-hover table-center mb-0">
                                            ...
                                            <tbody>
                                                <c:forEach items="${requestScope.typeRooms}" var="tr">
                                                    <tr>
                                                        <td>${tr.roomTypeID}</td>
                                                        <td>
                                                            <div class="room-wrap">
                                                                <a href="roomdetail" class="img-list" style="background-image: url(data:image/jpg;base64,${tr.base64Image});"></a>
                                                            </div>
                                                            </div>
                                                        </td>
                                                        <td>${tr.typeName}</td>
                                                        ...
                                                        <td class="text-right">
                                                            <div class="dropdown dropdown-action"> <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v ellipse_color"></i></a>
                                                                <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item" href="roomupdate?id=${tr.roomTypeID}"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a> <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_asset"><i class="fas fa-trash-alt m-r-5"></i> Delete</a> </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
