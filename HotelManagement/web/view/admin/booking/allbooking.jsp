<%-- 
    ...
    Created on : Oct 31, 2021, 1:49:16 PM
    Author     : Admin
--%>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="profile.html">${b.customer.name}</a>
                                                            </h2>
                                                        </td>
                                                        <td>${b.room.roomType.typeName}</td>
                                                        <td>${b.room.roomID}</td>
                                                        <td>${b.reservationDate}</td>
                                                        <td>${b.check_in}</td>
                                                        <td>${b.check_out}</td>
                                                        <!--<td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2652494b4b5f44435448474a66435e474b564a430845494b">${b.customer.email}</a></td>-->
