...
public class FilterLogin implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String logUrl = req.getContextPath() + "/auth/login";
        String url = req.getRequestURI();
        session.setAttribute("url", url);
        if (session.getAttribute("user") == null) {
            if (req.getRequestURI().endsWith("login") || req.getRequestURI().endsWith("homepage")) {
                try {
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("FilterLogin::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("FilterLogin::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("FilterLogin::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("FilterLogin::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("FilterLogin::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
